            ...
            >
              <CardHeader className="flex flex-row items-start justify-between">
                ...
                <Button 
                  ...
                  onClick={(e) => handleStarClick(e, snippet.id, !!snippet.starred)}
                >
          ...
          <DialogContent className="sm:max-w-[900px]">
            <DialogHeader className="flex flex-row items-start justify-between">
              ...
              <Button 
                variant="ghost" 
                size="icon" 
                onClick={(e) => handleStarClick(e, selectedSnippet.id, !!selectedSnippet.starred)}
                className="!size-8 -mr-2 -mt-2"
              >
                <Star className={`size-4 ${selectedSnippet.starred ? 'fill-primary text-primary' : 'text-muted-foreground'}`} />
              </Button>
            </DialogHeader>
